# Telegram - [Demo](https://telegram-livechat.herokuapp.com/)
...
1. Open [Telegram messenger](https://web.telegram.org/), search for `@tgLiveChatBot` and hit `/start` to get your chat ID. ([direct link](https://web.telegram.org/#/im?p=@tgLiveChatBot))
